...
privileged aspect RelacionIntegrationTest_Roo_IntegrationTest {
    
    declare @type: RelacionIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: RelacionIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: RelacionIntegrationTest: @Transactional;
    ...
    @Test
    public void RelacionIntegrationTest.testFindRelacion() {
    ...
    @Test
    public void RelacionIntegrationTest.testFlush() {
        Relacion obj = dod.getRandomRelacion();
        Assert.assertNotNull("Data on demand for 'Relacion' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Relacion' failed to provide an identifier", id);
        ...
        obj.flush();
        Assert.assertTrue("Version for 'Relacion' failed to increment on flush directive", (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
    ...
    public void RelacionIntegrationTest.testPersist() {
        ...
        obj.flush();
        Assert.assertNotNull("Expected 'Relacion' identifier to no longer be null", obj.getId());
    }
