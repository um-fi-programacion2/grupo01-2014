...
privileged aspect RepublicadoController_Roo_Controller {
    ...
    public String RepublicadoController.create(@Valid Republicado republicado, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, republicado);
    ...
    public String RepublicadoController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    public String RepublicadoController.update(@Valid Republicado republicado, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, republicado);
    ...
    public String RepublicadoController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        ...
        return "redirect:/republicadoes";
    }
    
    void RepublicadoController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("republicado_fecha_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
